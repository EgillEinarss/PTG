...
\item Tikz is (often) displaying terrible machines. (Not caused by Tikz!)
\end{itemize}
...
\indent \verb#java -jar PTG.jar Grammar [-Start symbol] [-End symbol] [-Empty symbol] #
...
\begin{figure}[H]
    \includegraphics[scale=0.4]{examples/exampleLR0M.png}
	\centering
